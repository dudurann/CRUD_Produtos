		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CRUD Produtos",
									"targetURL": "#comcoopersapcrudprodutos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcoopersapcrudprodutos-display": {
								"semanticObject": "comcoopersapcrudprodutos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.coopersap.crudprodutos",
									"url": sap.ui.require.toUrl("com/coopersap/crudprodutos")
								}
							}
						}
					}
